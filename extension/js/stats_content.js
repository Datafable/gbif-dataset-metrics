// This file contains code to generate elements on the stats page in a reusable way. 
...
var addMetricsToStatsPage = function (metrics) {
    ...
    DatasetMetrics.conf.statsPageBarContainer.append(html); // Add new metrics
    ...
    html =  '<article id="taxonomy">' +
                '<header></header>' +
                '<div class="content">' +
                    '<div class="header"><div class="left"><h2 id="taxonomy_partition_title">Taxonomy</h2></div></div>' +
                    '<div class="fullwidth" id="taxonomyPartition"></div>' +
                '</div>' +
                '<footer></footer>' +
            '</article>';
    DatasetMetrics.conf.statsPagePartitionContainer.after(html);
...
var taxonomyPartition = function (metrics) {
    ...
    var width = DatasetMetrics.conf.partitionWidth,
        height = DatasetMetrics.conf.partitionHeight,
